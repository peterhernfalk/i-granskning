...
def emptyrequest():
    ...
    html += "</ul>"
    html += "<br>"
    html += "<li>Parameter: <b>is</b></li>"
    html += "<ul>"
    html += "<li>Används när IS-dokumentets namn avviker från standardnamnsättningen</li>"
    html += "<li>Exempel på värde: IS_clinicalprocess_healthcond_actoutcome_getLaboratoryOrderOutcome.docx</li>"
    html += "</ul>"
    html += "<br>"
    ...
    html += "<br><i><a href='https://i-granskning.herokuapp.com/granskningsinfo?domain=clinicalprocess.activity.request&tag=1.0.2'>https://i-granskning.herokuapp.com/granskningsinfo?domain=clinicalprocess.activity.request&tag=1.0.2</a></i>"
    html += "<br><i><a href='https://i-granskning.herokuapp.com/granskningsinfo?domain=riv.supportprocess.serviceprovisioning.healthcareoffering&tag=2.0_RC7'>https://i-granskning.herokuapp.com/granskningsinfo?domain=riv.supportprocess.serviceprovisioning.healthcareoffering&tag=2.0_RC7</a></i>"
    html += "<br><i><a href='https://i-granskning.herokuapp.com/granskningsinfo?domain=infrastructure.eservicesupply.patientportal&tag=2.0&domainprefix=true'>https://i-granskning.herokuapp.com/granskningsinfo?domain=infrastructure.eservicesupply.patientportal&tag=2.0&domainprefix=true</a></i>"
    html += "<br><i><a href='https://i-granskning.herokuapp.com/granskningsinfo?domain=clinicalprocess.healthcond.actoutcome&tag=4.0.1&is=IS_clinicalprocess_healthcond_actoutcome_getLaboratoryOrderOutcome.docx'>https://i-granskning.herokuapp.com/granskningsinfo?domain=clinicalprocess.healthcond.actoutcome&tag=4.0.1&is=IS_clinicalprocess_healthcond_actoutcome_getLaboratoryOrderOutcome.docx</a></i>"
