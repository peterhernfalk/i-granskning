...
def perform_TKB_inspection(domain, tag, alt_document_name):
    ...
    # Tänkbar förbättring: kontrollera dokumentegenskaper avseende versionsnummer
    # Tänkbar förbättring: kontrollera versionsnummer på dokumentets första sida
    ...
    # Tänkbar förbättring: kontrollera om domännamnet nämns i inledningsparagrafen (det ska vara på engelska)
    # Tänkbar förbättring: visa innehåll i inledningens underparagraf (Svenskt namn), för manuell kontroll av svenskt namn och svenskt kortnamn
    ...
    # Tänkbar förbättring: kontrollera att det finns V-MIM-tabeller (en gemensam eller en per tjänstekontrakt)
    # Tänkbar förbättring: kontrollera att meddelandemodelltabellens attribut mappar mot motsvarande i xsd-schemas
